...
public class FriendService {
	...
	public List<?> otherFollowList(Member member) {
		// TODO Auto-generated method stub
		return friendDao.otherFollowList(member);
	}

	public List<?> otherFollowerList(Member member) {
		// TODO Auto-generated method stub
		return friendDao.otherFollowerList(member);
	}
