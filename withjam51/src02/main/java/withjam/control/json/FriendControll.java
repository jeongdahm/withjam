...
//	otherFollowList
	...
	@RequestMapping("/otherFollowList")
	  public Object otherFollowList(Member member) throws Exception{
...
//	    resultMap.put("MaxFriendNo", maxFriendNo.getCnt());
	    ...
	    resultMap.put("friends", 
	    		friendService.otherFollowList(member));
...
//	otherFollowerList
	...
	@RequestMapping("/otherFollowerList")
	  public Object otherFollowerList(Member member) throws Exception{
	    ...
	    resultMap.put("friends", 
	    		friendService.otherFollowerList(member));
